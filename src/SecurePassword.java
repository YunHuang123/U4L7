    ...
    */
    public String status()
    {
        ...
        if (!containsUppercase()) {
            status += "The password must have at least one uppercase letter\n";
        }
        if (!containsLowercase()) {
            status += "The password must have at least one lowercase letter\n";
        }
        if (!containsDigit()) {
            status += "The password must have at least one numeric number\n";
        }
        if (!containsSpecialSymbol()) {
            status += "The password must have at least one special symbol\n";
        }
        return status;
    }
